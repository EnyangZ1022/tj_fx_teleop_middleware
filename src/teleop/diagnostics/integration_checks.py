...
def validate_command_safety_defaults(command_config: object) -> list[str]:
    ...
    joint_limit_mode = str(getattr(command_config, "joint_limit_mode", "")).strip().lower()
    ...
    if joint_limit_mode != "reject":
        errors.append("joint_limit_mode should default to 'reject'")
